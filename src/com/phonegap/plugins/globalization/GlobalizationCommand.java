...
public class GlobalizationCommand extends Plugin {
	...
	private JSONObject getDatePattern(JSONArray options) throws GlobalizationError {
		...
		try {
			SimpleDateFormat fmtDate = (SimpleDateFormat) android.text.format.DateFormat.getDateFormat(this.ctx); // default
																													// user
																													// preference
																													// for
																													// date
			SimpleDateFormat fmtTime = (SimpleDateFormat) android.text.format.DateFormat.getTimeFormat(this.ctx); // default
																													// user
																													// preference
																													// for
																													// time
